...
if slam["method"] == "splatam":
    slam.update(
        ...
        room_cfg        = f"{dirs['cfg_dir']}/../mp3d_splatam.py",   # SplaTAM room configuration
        enable_active_planning = True,                             # enable/disable active planning
        dataset_eval_basedir = "data/mp3d_sim_nvs",
...
##################################################
planner = dict(
    method= "active_gs",                           # planner method [predefined_traj, active_lang]
